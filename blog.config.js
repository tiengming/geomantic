...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一个普通的打工人，这里记录我的学习和研究的一些内容,欢迎来到我的博客🎉',
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://github.com/muzhuyu/netpan/blob/main/touxiang.jpg', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  ALGOLIA_APP_ID: process.env.NEXT_PUBLIC_ALGOLIA_APP_ID || J0U5EI38NZ, // 在这里查看 https://dashboard.algolia.com/account/api-keys/
  ALGOLIA_ADMIN_APP_KEY: process.env.ALGOLIA_ADMIN_APP_KEY || f1098893ad6bcaad78efcdf7e011302d, // 管理后台的KEY，不要暴露在代码中，在这里查看 https://dashboard.algolia.com/account/api-keys/
  ALGOLIA_SEARCH_ONLY_APP_KEY: process.env.NEXT_PUBLIC_ALGOLIA_SEARCH_ONLY_APP_KEY || 8a57730f49a88caeb2f123dcd8baf878, // 客户端搜索用的KEY
  ALGOLIA_INDEX: process.env.NEXT_PUBLIC_ALGOLIA_INDEX || muzhuyu-study-notion, // 在Algolia中创建一个index用作数据库
